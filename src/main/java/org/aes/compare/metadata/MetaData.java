...
public class MetaData {
    ...
    public static final String NOT_FOUND_ANY_SAVED_STUDENT = ColorfulTextDesign.getTextForCanceledProcess("1111Has not found any saved student. Please save student first. " + PROCESS_IS_CANCELLED);
