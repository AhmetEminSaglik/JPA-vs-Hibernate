...
public class MetaData {
    ...
    public static final String PROCESS_IS_CANCELLED_FATAL = "Process is canceled. ";
    ...
    public static final String NOT_FOUND_ANY_SAVED_ADDRESS = "Has not found any saved address. Please save address first. " + PROCESS_IS_CANCELLED;
    ...
    public static final String STUDENT_PROCESS_CANCELLED_BECAUSE_ADDRESS_NOT_ATTACHED = "Student can not save without Address Data. " + PROCESS_IS_CANCELLED;
    public static final String NOT_FOUND_ANY_SAVED_STUDENT = "Has not found any saved student. Please save student first. " + PROCESS_IS_CANCELLED;
    public static final String STUDENT_UPDATE_PROCESS_IS_CANCELLED = "Student update Process is canceled ";
    ...
    public static final String STUDENT_DELETE_PROCESS_CANCELED = "Student Delete process is Cancelled";

    public static final String COURSE_NOT_SELECTED_PROCESS_CANCELED = "Course is not selected. " + PROCESS_IS_CANCELLED;
    ...
    public static final String NOT_FOUND_ANY_SAVED_EXAM_RESULT = "Has not found any saved Exam Result. Please save Exam Result first. " + PROCESS_IS_CANCELLED;
